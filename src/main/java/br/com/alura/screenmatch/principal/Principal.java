    ...
    public void exibeMenu() {
        ...
        while (opcao !=0) {
            var menu = """
                    ...
                    8- Buscar Temporadas e avaliação
...
//        dadosSeries.add(dados)
    ...
    private void buscarSeriesPorAtor(){
        ...
        System.out.println("Séries em quem o " +nomeAtor+" trabalhou: ");
seriesEncontradas.forEach(s ->
    ...
    private void filtrarSeriesPorTemporadaEAvaliacao(){
        ...
        System.out.println("Digite a nota de avaliação que a série deve possuir: ");
...
//                .peek(e -> System.out.println("Episodios com avaliação (N/A) "+e))
